        ...
        try {
            ...
            if (config) {
                ...
                setKhaiwalSection({
                    ...
                    gameSchedule: config.t1_khaiwalSection?.gameSchedule?.length > 0
                        ? config.t1_khaiwalSection.gameSchedule
                        : [...defaultGameSchedule]
                });
            }
        } catch (error) {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
            <div className="bg-white/15 backdrop-blur-lg border border-white/20 rounded-2xl p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
                <h3 className="text-white text-xl mb-6">T1 Site Configuration</h3>
